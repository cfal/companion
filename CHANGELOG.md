...
## [0.40.0](https://github.com/cfal/companion/compare/the-companion-v0.39.1...the-companion-v0.40.0) (2026-02-14)


### Features

* add Linux systemd support for service install/uninstall ([#169](https://github.com/cfal/companion/issues/169)) ([73fb3f7](https://github.com/cfal/companion/commit/73fb3f721efde79fec50f9c74a4f078f821c35d3))
* add MCP server management support ([#198](https://github.com/cfal/companion/issues/198)) ([018cf1f](https://github.com/cfal/companion/commit/018cf1f65ea5e281c19a39367f8cccf14ac56c1f))
* Add permission & plan approval E2E tests ([#6](https://github.com/cfal/companion/issues/6)) ([8590a68](https://github.com/cfal/companion/commit/8590a68657f0a06e94795a179ad4bbedae782c63))
* add release-please for automated npm publishing ([#24](https://github.com/cfal/companion/issues/24)) ([93b24ee](https://github.com/cfal/companion/commit/93b24ee4a12b3f32e81f59a348b25e89aaa86dce))
* allow dev server access over Tailscale/LAN ([#33](https://github.com/cfal/companion/issues/33)) ([9599d7a](https://github.com/cfal/companion/commit/9599d7ad4e2823d51c8fa262e1dcd96eeb056244))
* claude.md update ([7fa4e7a](https://github.com/cfal/companion/commit/7fa4e7adfdc7c409cfeed4e8a11f237ff0572234))
* **cli:** add service install/uninstall and separate dev/prod ports ([#155](https://github.com/cfal/companion/issues/155)) ([a4e5ba6](https://github.com/cfal/companion/commit/a4e5ba6ced2cc8041f61b303b0205f36e50b7594))
* **cli:** add stop and restart service commands ([#185](https://github.com/cfal/companion/issues/185)) ([04da8e5](https://github.com/cfal/companion/commit/04da8e5a3d3f0e363f662cdd6bca6145eaec479f))
* **cli:** start and stop Companion via daemon service ([#201](https://github.com/cfal/companion/issues/201)) ([39e2b79](https://github.com/cfal/companion/commit/39e2b79a6dbb70e7c7dcaf3ccbaf2116ac26b43a))
* **codex:** add offline protocol compatibility guardrails and playground coverage ([#194](https://github.com/cfal/companion/issues/194)) ([bf0a43e](https://github.com/cfal/companion/commit/bf0a43e5fdc791166e76391c0ee1ad3cf18dae10))
* Corriger menu dossier mobile et décalage clavier ([#151](https://github.com/cfal/companion/issues/151)) ([8068925](https://github.com/cfal/companion/commit/8068925f6a5ec5c6b7a40b36398bd4f9be04708d))
* e2e permissions plans ([#9](https://github.com/cfal/companion/issues/9)) ([53b38bf](https://github.com/cfal/companion/commit/53b38bfd4e773454492a3fea10e8db7ffd3fd768))
* Fix Diffs panel for worktree/relative paths and untracked files ([#165](https://github.com/cfal/companion/issues/165)) ([6810643](https://github.com/cfal/companion/commit/681064328d2bf3f4fc5c3a1867abc1536d2d54f3))
* Hide successful no-output command results ([#139](https://github.com/cfal/companion/issues/139)) ([a66e386](https://github.com/cfal/companion/commit/a66e386491e6887c5684cd70f63cc49cac0a64b7))
* **landing:** add marketing landing page for thecompanion.sh ([#128](https://github.com/cfal/companion/issues/128)) ([170b89c](https://github.com/cfal/companion/commit/170b89c72012dfb0ba68239a7665634d65275aa3))
* OpenRouter-based session auto-naming + settings page ([#168](https://github.com/cfal/companion/issues/168)) ([a86b1e7](https://github.com/cfal/companion/commit/a86b1e711ff1c38985bb3d622c6ec372a266637e))
* protocol conformance fixes and improved E2E tests ([#14](https://github.com/cfal/companion/issues/14)) ([51b13b9](https://github.com/cfal/companion/commit/51b13b9d647de6c92881b1abb61161f39152e0ef))
* Redesign README as a landing page with API-first documentation ([#7](https://github.com/cfal/companion/issues/7)) ([a59e1b4](https://github.com/cfal/companion/commit/a59e1b4604baf87faa32af7d62e4846afae49dbe))
* **settings:** add application update controls to settings ([#234](https://github.com/cfal/companion/issues/234)) ([17760af](https://github.com/cfal/companion/commit/17760afb3cade5e325b7771cabbe0f78034512e5))
* **sidebar:** group sound and alerts under notification ([#203](https://github.com/cfal/companion/issues/203)) ([0077e75](https://github.com/cfal/companion/commit/0077e75208e7505a53db8a829a9480a77b8c3916))
* simplified claude() API, unified endpoints, and landing page README ([#12](https://github.com/cfal/companion/issues/12)) ([aa2e535](https://github.com/cfal/companion/commit/aa2e535fe0a83b726ff2a2c08359e55973a9136b))
* **telemetry:** add posthog analytics, opt-out controls, and CI env wiring ([#238](https://github.com/cfal/companion/issues/238)) ([743aeab](https://github.com/cfal/companion/commit/743aeab86aa5b9141c86f605bbd3572694c80113))
* The Vibe Companion complete web UI rewrite + npm package ([#23](https://github.com/cfal/companion/issues/23)) ([0bdc77a](https://github.com/cfal/companion/commit/0bdc77a81b21cd9d08ba29ea48844e73df3a1852))
* trigger release for statusline capture ([#19](https://github.com/cfal/companion/issues/19)) ([cedc9df](https://github.com/cfal/companion/commit/cedc9dfb7445344bdb43a1a756f1d2e538e08c76))
* **ui:** show session name in top bar ([#228](https://github.com/cfal/companion/issues/228)) ([a9dc926](https://github.com/cfal/companion/commit/a9dc926d761c2dbbef741a2e7b05ecba29bd29b8))
* **web:** adaptive server-side PR polling with WebSocket push ([#178](https://github.com/cfal/companion/issues/178)) ([57939e4](https://github.com/cfal/companion/commit/57939e4030a4b0e5a7dae39d93c34944e3bdff0f))
* **web:** add browser web notifications ([#191](https://github.com/cfal/companion/issues/191)) ([092c59a](https://github.com/cfal/companion/commit/092c59aff620aa2b2eac51903c01ad7cb0c4bc8e))
* **web:** add CLAUDE.md editor button in TopBar ([#170](https://github.com/cfal/companion/issues/170)) ([f553b9b](https://github.com/cfal/companion/commit/f553b9b86842f0b47c0bf24b08903e0352b7b078))
* **web:** add Clawd-inspired pixel art logo and favicon ([#70](https://github.com/cfal/companion/issues/70)) ([b3994ef](https://github.com/cfal/companion/commit/b3994eff2eac62c3cf8f40a8c31b720c910a7601))
* **web:** add component playground and ExitPlanMode display ([#36](https://github.com/cfal/companion/issues/36)) ([e958be7](https://github.com/cfal/companion/commit/e958be780f1b6e1a8f65daedbf968cdf6ef47798))
* **web:** add embedded code editor with file tree, changed files tracking, and diff view ([#81](https://github.com/cfal/companion/issues/81)) ([3ed0957](https://github.com/cfal/companion/commit/3ed095790c73edeef911ab4c73d74f1998100c5c))
* **web:** add embedded terminal in sidebar ([#175](https://github.com/cfal/companion/issues/175)) ([e711c5d](https://github.com/cfal/companion/commit/e711c5d5ef40edfa9c265642383a4c526b9b3ece))
* **web:** add git worktree support for isolated multi-branch sessions ([#64](https://github.com/cfal/companion/issues/64)) ([fee39d6](https://github.com/cfal/companion/commit/fee39d62986cd99700ba78c84a1f586331955ff8))
* **web:** add GitHub PR status to TaskPanel sidebar ([#166](https://github.com/cfal/companion/issues/166)) ([6ace3b2](https://github.com/cfal/companion/commit/6ace3b2944ec9e9082a11a45fe0798f0f5f41e55))
* **web:** add missing message-flow components to Playground ([#156](https://github.com/cfal/companion/issues/156)) ([ef6c27d](https://github.com/cfal/companion/commit/ef6c27dfa950c11b09394c74c4452c0b02aed8fb))
* **web:** add notification sound on task completion ([#99](https://github.com/cfal/companion/issues/99)) ([337c735](https://github.com/cfal/companion/commit/337c735e8267f076ada4b9ef01632d37376ec2d0))
* **web:** add OpenAI Codex CLI backend integration ([#100](https://github.com/cfal/companion/issues/100)) ([54e3c1a](https://github.com/cfal/companion/commit/54e3c1a2b359719d7983fa9ee857507e1446f505))
* **web:** add per-session usage limits with OAuth refresh and Codex support ([24ebd32](https://github.com/cfal/companion/commit/24ebd32f5ec617290b6b93e8bc76972a3b80d6a9))
* **web:** add permission suggestions and pending permission indicators ([10422c1](https://github.com/cfal/companion/commit/10422c1464b6ad4bc45eb90e6cd9ebbc0ebeac92))
* **web:** add PWA support for mobile home screen install ([#116](https://github.com/cfal/companion/issues/116)) ([85e605f](https://github.com/cfal/companion/commit/85e605fd758ee952e0d5b1dbc6f7065b514844a7))
* **web:** add update-available banner with auto-update for service mode ([#158](https://github.com/cfal/companion/issues/158)) ([727bd7f](https://github.com/cfal/companion/commit/727bd7fbd16557fd63ce41632592c1485e69713c))
* **web:** add usage limits display in session panel ([#97](https://github.com/cfal/companion/issues/97)) ([d29f489](https://github.com/cfal/companion/commit/d29f489ed9951d36ff45ec240410ffd8ffdf05eb))
* **web:** archive sessions instead of deleting them ([#56](https://github.com/cfal/companion/issues/56)) ([489d608](https://github.com/cfal/companion/commit/489d6087fc99b9131386547edaf3bd303a114090))
* **web:** enlarge homepage logo as hero element ([#71](https://github.com/cfal/companion/issues/71)) ([18ead74](https://github.com/cfal/companion/commit/18ead7436d3ebbe9d766754ddb17aa504c63703f))
* **web:** git fetch on branch picker open ([#72](https://github.com/cfal/companion/issues/72)) ([f110405](https://github.com/cfal/companion/commit/f110405edbd0f00454edd65ed72197daf0293182))
* **web:** git info display, folder dropdown fix, dev workflow ([#43](https://github.com/cfal/companion/issues/43)) ([1fe2069](https://github.com/cfal/companion/commit/1fe2069a7db17b410e383f883c934ee1662c2171))
* **web:** git worktree support with branch picker and git pull ([#65](https://github.com/cfal/companion/issues/65)) ([4d0c9c8](https://github.com/cfal/companion/commit/4d0c9c83f4fe13be863313d6c945ce0b671a7f8a))
* **web:** group sidebar sessions by project directory ([#117](https://github.com/cfal/companion/issues/117)) ([deceb59](https://github.com/cfal/companion/commit/deceb599975f53141e9c0bd6c7675437f96978b8))
* **web:** named environment profiles (~/.companion/envs/) ([#50](https://github.com/cfal/companion/issues/50)) ([eaa1a49](https://github.com/cfal/companion/commit/eaa1a497f3be61f2f71f9467e93fa2b65be19095))
* **web:** persist sessions to disk for dev mode resilience ([#45](https://github.com/cfal/companion/issues/45)) ([c943d00](https://github.com/cfal/companion/commit/c943d0047b728854f059e26facde950e08cdfe0c))
* **web:** redesign session list with avatars, auto-reconnect, and git info ([#111](https://github.com/cfal/companion/issues/111)) ([8a7284b](https://github.com/cfal/companion/commit/8a7284b3c08dc301a879924aea133945697b037a))
* **web:** replace CodeMirror editor with unified diff viewer ([#160](https://github.com/cfal/companion/issues/160)) ([f9b6869](https://github.com/cfal/companion/commit/f9b686902011ffd194a118cc1cb022bac71eaa3b))
* **web:** replace folder picker dropdown with fixed-size modal ([#76](https://github.com/cfal/companion/issues/76)) ([979e395](https://github.com/cfal/companion/commit/979e395b530cdb21e6a073ba60e33ea8ac497e2a))
* **web:** session rename persistence + auto-generated titles ([#79](https://github.com/cfal/companion/issues/79)) ([e1dc58c](https://github.com/cfal/companion/commit/e1dc58ce8ab9a619d36f2261cce89b90cfdb70d6))
* **web:** warn when branch is behind remote before session creation ([#127](https://github.com/cfal/companion/issues/127)) ([ef89d5c](https://github.com/cfal/companion/commit/ef89d5c208ca5da006aaa88b78dbd647186fb0df))


### Bug Fixes

* add web/dist to gitignore ([#2](https://github.com/cfal/companion/issues/2)) ([b9ac264](https://github.com/cfal/companion/commit/b9ac264fbb99415517636517e8f503d40fe3253d))
* always update statusLine settings on agent spawn ([#21](https://github.com/cfal/companion/issues/21)) ([71c343c](https://github.com/cfal/companion/commit/71c343cfd29fff3204ad0cc2986ff000d1be5adc))
* auto-accept workspace trust prompt and handle idle in ask() ([#16](https://github.com/cfal/companion/issues/16)) ([ded31b4](https://github.com/cfal/companion/commit/ded31b4cf9900f7ed8c3ff373ef16ae8f1e8a886))
* checkout selected branch when worktree mode is off ([#68](https://github.com/cfal/companion/issues/68)) ([500f3b1](https://github.com/cfal/companion/commit/500f3b112c5ccc646c7965344b5774efe1338377))
* **cli-launcher:** bypass shebang to use correct Node for Codex ([#223](https://github.com/cfal/companion/issues/223)) ([9fe1583](https://github.com/cfal/companion/commit/9fe158358880789ec80ea5bd5daf738a261089dc))
* **cli-launcher:** pass enriched PATH to spawned CLI/Codex processes ([#221](https://github.com/cfal/companion/issues/221)) ([661e8b4](https://github.com/cfal/companion/commit/661e8b45d9909b9e59b0ecb396a4fb7a143f2816))
* **cli:** auto-update restarts service reliably via explicit systemctl/launchctl ([#208](https://github.com/cfal/companion/issues/208)) ([33fa67e](https://github.com/cfal/companion/commit/33fa67ebd75609b9a7b8700ce67b1dd949663b06))
* **cli:** expose stop/restart in help and add test ([#188](https://github.com/cfal/companion/issues/188)) ([c307525](https://github.com/cfal/companion/commit/c30752545f2137fd7c03525d5bb7f5f8851271d4))
* **cli:** fix Linux systemd service management (start, auto-restart) ([#213](https://github.com/cfal/companion/issues/213)) ([fc1dd65](https://github.com/cfal/companion/commit/fc1dd65a9fd32958d47499af1b35992a0c10fe8e))
* **cli:** refresh systemd unit file on start/restart to prevent restart loops ([#215](https://github.com/cfal/companion/issues/215)) ([35f80d9](https://github.com/cfal/companion/commit/35f80d963b1f0f0feccf7215a9bd4711b4520a12))
* **cli:** resolve binaries via user shell PATH when running as service ([#216](https://github.com/cfal/companion/issues/216)) ([47e4967](https://github.com/cfal/companion/commit/47e4967215a5bfd84c8afc2a86ce42151c73d187))
* **codex:** fix 3 critical bugs in Codex backend integration ([#147](https://github.com/cfal/companion/issues/147)) ([0ec92db](https://github.com/cfal/companion/commit/0ec92db909c7be42f94cc21d2890c9c123702dd7))
* **codex:** handle init failure gracefully and isolate per-session CODEX_HOME ([#210](https://github.com/cfal/companion/issues/210)) ([f4efcea](https://github.com/cfal/companion/commit/f4efceace6c260de92df728335678b7bded3e144))
* **landing:** focus messaging on codex, mcp, terminal and secure remote setup ([#237](https://github.com/cfal/companion/issues/237)) ([80759a7](https://github.com/cfal/companion/commit/80759a7ed3209d8aebf1e108d3e0c68d7bb8824f))
* make service stop actually stop on macOS and refresh stale update checks ([#192](https://github.com/cfal/companion/issues/192)) ([f608f64](https://github.com/cfal/companion/commit/f608f64887bf78b2cca909aa20bd87e4a897ce94))
* remove vibe alias, update repo URLs to companion ([#30](https://github.com/cfal/companion/issues/30)) ([4f7b47c](https://github.com/cfal/companion/commit/4f7b47cba86c278e89fe81292fea9b8b3e75c035))
* scope permission requests to their session tab ([#35](https://github.com/cfal/companion/issues/35)) ([ef9f41c](https://github.com/cfal/companion/commit/ef9f41c8589e382de1db719984931bc4e91aeb11))
* **settings:** correct auto-renaming helper copy ([#230](https://github.com/cfal/companion/issues/230)) ([5da1586](https://github.com/cfal/companion/commit/5da15865508e6ae5bbcda45e149f64bc966b141c))
* show pasted images in chat history ([#32](https://github.com/cfal/companion/issues/32)) ([46365be](https://github.com/cfal/companion/commit/46365be45ae8b325100ed296617455c105d4d52e))
* **sidebar:** nest notification toggles behind disclosure ([#207](https://github.com/cfal/companion/issues/207)) ([87e71b8](https://github.com/cfal/companion/commit/87e71b8f5bf3e47c96421bca315ac412934a7dc2))
* **task-panel:** enable scrolling for long MCP sections ([#204](https://github.com/cfal/companion/issues/204)) ([b98abbb](https://github.com/cfal/companion/commit/b98abbbea4355c7e91d4dc322e53e638f4e4c542))
* track all commits in release-please, not just web/ ([#27](https://github.com/cfal/companion/issues/27)) ([d49f649](https://github.com/cfal/companion/commit/d49f64996d02807baf0482ce3c3607ae59f78638))
* **ui:** keep session action controls visible on mobile ([#247](https://github.com/cfal/companion/issues/247)) ([209ac9a](https://github.com/cfal/companion/commit/209ac9a3f2d5bd99e3e2dbe46dc9eb7b10e40082))
* **ui:** move terminal, settings, and environments to full pages ([#224](https://github.com/cfal/companion/issues/224)) ([be1de35](https://github.com/cfal/companion/commit/be1de35e816ac782d4ba5c948f0b00abf0641f75))
* use correct secret name NPM_PUBLISH_TOKEN in publish workflow ([e296ab0](https://github.com/cfal/companion/commit/e296ab0fabd6345b1f21c7094ca1f8d6f6af79cb))
* use correct secret name NPM_PUBLISH_TOKEN in publish workflow ([#26](https://github.com/cfal/companion/issues/26)) ([61eed5a](https://github.com/cfal/companion/commit/61eed5addd6e332fac360d9ae8239f1b0f93868e))
* use random suffixes for worktree branch names ([#88](https://github.com/cfal/companion/issues/88)) ([0b79f9a](https://github.com/cfal/companion/commit/0b79f9af172595cb84810b5d4cd65e0ed9c8e23d))
* **web:** always generate unique branch names for worktrees with forceNew ([#131](https://github.com/cfal/companion/issues/131)) ([cd62d4a](https://github.com/cfal/companion/commit/cd62d4ac8fae0b56cdef0ff850eab4a8c707f99b))
* **web:** chat scroll and composer visibility in plan mode ([#55](https://github.com/cfal/companion/issues/55)) ([4cff10c](https://github.com/cfal/companion/commit/4cff10cde297b7142c088584b6dd83060902c526))
* **web:** compare file diffs against default branch ([#226](https://github.com/cfal/companion/issues/226)) ([b437d2c](https://github.com/cfal/companion/commit/b437d2c5705ee32cb4e7964dd1d33113d3470f9d))
* **web:** deduplicate messages on WebSocket reconnection ([#150](https://github.com/cfal/companion/issues/150)) ([a81bb3d](https://github.com/cfal/companion/commit/a81bb3d878957f1f18234a5f9194d1d8064f795c))
* **web:** default folder picker to home directory instead of server cwd ([#122](https://github.com/cfal/companion/issues/122)) ([7b8a4c7](https://github.com/cfal/companion/commit/7b8a4c71f32c68ffcc907269e88b3711c0d5af7a))
* **web:** enable codex web search when internet toggle is on ([#135](https://github.com/cfal/companion/issues/135)) ([8d9f0b0](https://github.com/cfal/companion/commit/8d9f0b002dcafcfc020862cb107777d75fc2580e))
* **web:** fetch and pull selected branch on session create ([#137](https://github.com/cfal/companion/issues/137)) ([9cdbbe1](https://github.com/cfal/companion/commit/9cdbbe1e151f024bd41f60e20c60e2f092ba7014))
* **web:** fix Codex approval policy and Composer mode labels ([#106](https://github.com/cfal/companion/issues/106)) ([fd5c2f1](https://github.com/cfal/companion/commit/fd5c2f15b144eb2ae9ec809fdb6ee19e797dc15a))
* **web:** fix session auto-rename and add blur-to-focus animation ([#86](https://github.com/cfal/companion/issues/86)) ([6d3c91f](https://github.com/cfal/companion/commit/6d3c91f73a65054e2c15727e90ca554af70eed28))
* **web:** fix WritableStream locked race condition in Codex adapter ([b43569d](https://github.com/cfal/companion/commit/b43569dbb3d154a303d60ec6bc2007b5a7bcedea))
* **web:** improve light mode contrast ([#89](https://github.com/cfal/companion/issues/89)) ([7ac7886](https://github.com/cfal/companion/commit/7ac7886fc6305e3ec45698a1c7c91b72a91c7c44))
* **web:** improve responsive design across all components ([#85](https://github.com/cfal/companion/issues/85)) ([0750fbb](https://github.com/cfal/companion/commit/0750fbbbe456d79bc104fdbdaf8f08e8795a3b62))
* **web:** isolate worktree sessions with proper branch-tracking ([#74](https://github.com/cfal/companion/issues/74)) ([764d7a7](https://github.com/cfal/companion/commit/764d7a7f5391a686408a8542421f771da341d5db))
* **web:** polyfill localStorage for Node.js 22+ ([#149](https://github.com/cfal/companion/issues/149)) ([602c684](https://github.com/cfal/companion/commit/602c6841f03677ec3f419860469e39b791968de6))
* **web:** prevent iOS auto-zoom on mobile input focus ([#102](https://github.com/cfal/companion/issues/102)) ([18ee23f](https://github.com/cfal/companion/commit/18ee23f6f1674fbcf5e1be25f8c4e23510bc12b5))
* **web:** prevent mobile keyboard layout shift and iOS zoom on branch selector ([#159](https://github.com/cfal/companion/issues/159)) ([4276afd](https://github.com/cfal/companion/commit/4276afd4390808d9d040555652c80bd1461c45b7))
* **web:** refresh git branch tracking after session start ([#195](https://github.com/cfal/companion/issues/195)) ([c3cb47b](https://github.com/cfal/companion/commit/c3cb47b56257b866b76abbb66709694cb26e0925))
* **web:** resolve [object Object] display for Codex file edit results ([#133](https://github.com/cfal/companion/issues/133)) ([9cc21a7](https://github.com/cfal/companion/commit/9cc21a78064cf07bb90174dd87bbfbd367516c90))
* **web:** resolve original repo root for worktree sessions in sidebar grouping ([#120](https://github.com/cfal/companion/issues/120)) ([8925ac9](https://github.com/cfal/companion/commit/8925ac9f540b3cd2520268539d21b0267b2dadb1))
* **web:** session reconnection with auto-relaunch and persist ([#49](https://github.com/cfal/companion/issues/49)) ([f58e542](https://github.com/cfal/companion/commit/f58e5428847a342069e6790fa7d70f190bc5f396))
* **web:** stable session ordering — sort by creation date only ([#173](https://github.com/cfal/companion/issues/173)) ([05c3a06](https://github.com/cfal/companion/commit/05c3a0652b823c5ca20b233be164a899f9920caf))
* **web:** unset CLAUDECODE env var to prevent CLI nesting guard rejec… ([#181](https://github.com/cfal/companion/issues/181)) ([75e264a](https://github.com/cfal/companion/commit/75e264a0be975dadbf3d56e64b990e0e07b12777))
* **web:** use --resume on CLI relaunch to restore conversation context ([#46](https://github.com/cfal/companion/issues/46)) ([3e2b5bd](https://github.com/cfal/companion/commit/3e2b5bdd39bd265ca5675784227a9f1b4f2a8aa3))
* **ws:** add durable replay cursors and idempotent message handling ([#232](https://github.com/cfal/companion/issues/232)) ([fba76e7](https://github.com/cfal/companion/commit/fba76e730ea5398a2df9dbda2167c32f49c7668f))
